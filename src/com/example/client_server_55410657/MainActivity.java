package com.example.client_server_55410657;
...
public class MainActivity extends Activity {
	...
	ArrayList<HashMap<String, String>> stundeList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		stundeList = new ArrayList<HashMap<String,String>>();
	...
	class LoadAllStudent extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			...
			dialog.setMessage("Lading student. Please waite...." );
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					ListAdapter adapter = new SimpleAdapter(MainActivity.this,
							stundeList, R.layout.item_show, new String[] {
							TAG_ID, TAG_STUID, TAG_NAME, TAG_TEL },
					new int[] {R.id.ColName, R.id.ColStuID,
